namespace BinaryPlate.BlazorPlate.Pages.Users;

public partial class UserRolesForAdd
{
    ...
    {
        var parameters = new DialogParameters { { nameof(RolesLookupDialog.SelectedUserRoles), RoleItems.ToList() } };
