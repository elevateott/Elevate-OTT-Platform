...
/// using the specified (or default) comparer for the key type. </summary> <typeparam
/// name="TSource">Type of elements which this comparer will be asked to compare</typeparam>
...
public class ProjectionEqualityComparer<TSource, TKey> : IEqualityComparer<TSource>
{
    ...
    public int GetHashCode(TSource sourceObject)
    {
        ...
        return comparer.GetHashCode(projection(sourceObject));
    }
