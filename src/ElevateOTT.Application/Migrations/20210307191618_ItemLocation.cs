    ...
    public partial class ItemLocation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AccessTokenExpiryTime = table.Column<int>(type: "int", nullable: true),
                    RefreshTokenExpiryTime = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserAttachments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationUserAttachments_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserAttachments_UserId",
                table: "ApplicationUserAttachments",
                column: "UserId");
